...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<div> <img src='images/cart_empty.png' class='image-fluid' height='150' width='150'></div><br/>";
    echo "<div class='text-bold h5' style='text-align: center;'>Add items to the cart first!<div>";
